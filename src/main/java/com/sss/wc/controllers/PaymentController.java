...
public class PaymentController implements Serializable {
    ...
    @EJB
    private com.sss.wc.facades.PaymentFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleBills").getString("PaymentCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleBills").getString("PaymentUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleBills").getString("PaymentDeleted"));
        if (!JsfUtil.isValidationFailed()) {
